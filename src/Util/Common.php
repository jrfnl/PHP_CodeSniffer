...
class Common
{
     ...
     * @return boolean
     *
     * @deprecated 3.5.0 Use PHP_CodeSniffer\Util\NameUtils::isCamelCaps() instead.
     */
    public static function isCamelCaps(
        ...
        return NameUtils::isCamelCaps($string, $classFormat, $public, $strict);
     ...
     * @return boolean
     *
     * @deprecated 3.5.0 Use PHP_CodeSniffer\Util\NameUtils::isUnderscoreName() instead.
     */
    public static function isUnderscoreName($string)
    {
        return NameUtils::isUnderscoreName($string);
