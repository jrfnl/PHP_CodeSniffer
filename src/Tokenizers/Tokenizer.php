...
abstract class Tokenizer
{
    ...
    private function createTokenMap()
    {
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** START TOKEN MAP ***', 1);
        }
        ...
        for ($i = 0; $i < $this->numTokens; $i++) {
            ...
            */
            ...
            if (isset(Tokens::$parenthesisOpeners[$this->tokens[$i]['code']]) === true) {
                ...
                if ($openOwner !== null) {
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage("=> Found parenthesis opener at $i for $openOwner", count($openers));
                    }
                ...
                if ($numOpeners !== 0) {
                    ...
                    if (isset($this->tokens[$opener]['parenthesis_owner']) === true) {
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage("=> Found parenthesis closer at $i for $owner", (count($openers) + 1));
                        }
                    } else if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage("=> Found unowned parenthesis closer at $i for $opener", (count($openers) + 1));
                    }
            ...
            */
            ...
            case T_CLOSE_SQUARE_BRACKET:
                if (empty($squareOpeners) === false) {
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage("=> Found square bracket closer at $i for $opener", (count($squareOpeners) + count($curlyOpeners) + 1));
                    }
                }
                break;
            case T_CLOSE_CURLY_BRACKET:
                if (empty($curlyOpeners) === false
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage("=> Found curly bracket closer at $i for $opener", (count($squareOpeners) + count($curlyOpeners) + 1));
                    }
                }
                break;
            default:
        ...
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** END TOKEN MAP ***', 1);
        }
    ...
    {
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** START SCOPE MAP ***', 1);
        }
        ...
        for ($i = 0; $i < $this->numTokens; $i++) {
            ...
            if (isset($this->scopeOpeners[$this->tokens[$i]['code']]) === true) {
                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                    ...
                    Common::printStatusMessage("Start scope map at $i:$type => $content", 1);
                }

                if (isset($this->tokens[$i]['scope_condition']) === true) {
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage('* already processed, skipping *', 1);
                    }
        ...
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** END SCOPE MAP ***', 1);
        }
    ...
    {
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage("=> Begin scope map recursion at token $stackPtr with depth $depth", $depth);
        }
        ...
        for ($i = ($stackPtr + 1); $i < $this->numTokens; $i++) {
            ...
            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                ...
                Common::printStatusMessage($statusMessage, $depth);
            }//end if
            ...
            if (($currType === T_IF || $currType === T_ELSE || $currType === T_USE)
                ...
                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                    ...
                    Common::printStatusMessage("=> Found $closerType before scope opener for $stackPtr:$type, bailing", $depth);
                }
            ...
            if ($opener === null
                ...
                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                    $type = $this->tokens[$stackPtr]['type'];
                    Common::printStatusMessage("=> Found curly brace closer before scope opener for $stackPtr:$type, bailing", $depth);
                }
            ...
            if ($opener !== null
                ...
                if ($ignore > 0 && $tokenType === T_CLOSE_CURLY_BRACKET) {
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage('* finished ignoring curly brace *', $depth);
                    }
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        $type = $this->tokens[$stackPtr]['type'];
                        Common::printStatusMessage("=> Ignoring non-curly scope closer for $stackPtr:$type", $depth);
                    }
                } else {
                    $scopeCloser = $i;
                    $todo        = [
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        ...
                        Common::printStatusMessage("=> Found scope closer ($scopeCloser:$closerType) for $stackPtr:$type", $depth);
                    }
                    ...
                    if (($this->tokens[$stackPtr]['code'] === T_IF || $this->tokens[$stackPtr]['code'] === T_ELSEIF)
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('* closer needs to be tested *', $depth);
                        }
                        ...
                        if (isset($this->tokens[$scopeCloser]['scope_opener']) === false) {
                            $validCloser = false;
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                Common::printStatusMessage('* closer is not valid (no opener found) *', $depth);
                            }
                            ...
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                ...
                                Common::printStatusMessage("* closer is not valid (mismatched opener type; $type != $openerType) *", $depth);
                            }
                        } else if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('* closer was valid *', $depth);
                        }
                    } else {
            ...
            if (isset($this->scopeOpeners[$tokenType]) === true) {
                if ($opener === null) {
                    ...
                    if ($tokenType === T_FUNCTION
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            $type = $this->tokens[$stackPtr]['type'];
                            Common::printStatusMessage("=> Found function before scope opener for $stackPtr:$type, processing manually", $depth);
                        }

                        if (isset($this->tokens[$i]['scope_closer']) === true) {
                            // We've already processed this closure.
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                Common::printStatusMessage('* already processed, skipping *', $depth);
                            }
                    ...
                    if ($tokenType === T_CLASS) {
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            $type = $this->tokens[$stackPtr]['type'];
                            Common::printStatusMessage("=> Found class before scope opener for $stackPtr:$type, processing manually", $depth);
                        }
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        $type = $this->tokens[$stackPtr]['type'];
                        Common::printStatusMessage("=> Found new opening condition before scope opener for $stackPtr:$type, ", $depth, true);
                    }
                    ...
                    if (($this->tokens[$stackPtr]['code'] === T_IF
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('continuing');
                        }

                        return ($i - 1);
                    } else {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('backtracking');
                        }
                ...
                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                    Common::printStatusMessage('* token is an opening condition *', $depth);
                }
                ...
                if (isset($this->tokens[$i]['scope_condition']) === true) {
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage('* it was another token\'s opener, bailing *', $depth);
                    }

                    return $stackPtr;
                } else {
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage('* searching for opener *', $depth);
                    }
                    ...
                    if ($depth > 50) {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('* reached maximum nesting level; aborting *', $depth);
                        }
            ...
            if (isset($this->scopeOpeners[$currType]['start'][$tokenType]) === true
                ...
                if ($tokenType === T_OPEN_CURLY_BRACKET) {
                    if (isset($this->tokens[$stackPtr]['parenthesis_closer']) === true
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            Common::printStatusMessage('* ignoring curly brace inside condition *', $depth);
                        }
                        ...
                        for ($x = ($i - 1); $x > 0; $x--) {
                            if (isset(Tokens::$emptyTokens[$this->tokens[$x]['code']]) === true) {
                                ...
                                if (isset($disallowed[$this->tokens[$x]['code']]) === true) {
                                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                        Common::printStatusMessage('* ignoring curly brace *', $depth);
                                    }
                ...
                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                    $type = $this->tokens[$stackPtr]['type'];
                    Common::printStatusMessage("=> Found end of statement before scope opener for $stackPtr:$type, continuing", $depth);
                }
                ...
                if ($this->tokens[$i]['line'] >= ($startLine + 30)
                    ...
                    if ($this->scopeOpeners[$currType]['strict'] === true) {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            ...
                            Common::printStatusMessage("=> Still looking for $stackPtr:$type scope opener after $lines lines", $depth);
                        }
                    } else {
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            $type = $this->tokens[$stackPtr]['type'];
                            Common::printStatusMessage("=> Couldn't find scope opener for $stackPtr:$type, bailing", $depth);
                        }
                ...
                if (isset($this->tokens[$i]['scope_condition']) === false) {
                    if ($ignore > 0) {
                        ...
                        if (PHP_CODESNIFFER_VERBOSITY > 1) {
                            $type = $this->tokens[$stackPtr]['type'];
                            Common::printStatusMessage("=> Found (unexpected) scope closer for $stackPtr:$type", $depth);
                        }
    ...
    {
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** START LEVEL MAP ***', 1);
        }
        ...
        for ($i = 0; $i < $this->numTokens; $i++) {
            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                ...
                $statusMessage .= "]: $type => $content";
                Common::printStatusMessage($statusMessage, ($level + 1));
            }//end if
            ...
            if (isset($this->tokens[$i]['scope_condition']) === true) {
                ...
                if ($this->tokens[$i]['scope_opener'] === $i) {
                    ...
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        $type = $this->tokens[$stackPtr]['type'];
                        Common::printStatusMessage("=> Found scope opener for $stackPtr:$type", ($level + 1));
                    }
                    ...
                    if ($lastOpener !== null && $this->tokens[$lastOpener]['scope_closer'] === $this->tokens[$i]['scope_closer']) {
                        ...
                        if ($isShared === true && $sameEnd === true) {
                            ...
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                ...
                                Common::printStatusMessage("* shared closer, cleaning up $badToken:$type *", ($level + 1));
                            }
                            ...
                            for ($x = $this->tokens[$i]['scope_condition']; $x <= $i; $x++) {
                                ...
                                if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                    ...
                                    Common::printStatusMessage("* cleaned $x:$type *", ($level + 1));
                                    Common::printStatusMessage("=> level changed from $oldLevel to $newLevel", ($level + 2));
                                    Common::printStatusMessage("=> conditions changed from $oldConds to $newConds", ($level + 2));
                                }//end if
                            }//end for
                            ...
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                $type = $this->tokens[$badToken]['type'];
                                Common::printStatusMessage("* token $badToken:$type removed from conditions array *", ($level + 1));
                            }
                            ...
                            $level--;
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                Common::printStatusMessage('* level decreased *', ($level + 2));
                            }
                        }//end if
                    }//end if
                    ...
                    $level++;
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        Common::printStatusMessage('* level increased *', ($level + 1));
                    }

                    $conditions[$stackPtr] = $this->tokens[$stackPtr]['code'];
                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                        $type = $this->tokens[$stackPtr]['type'];
                        Common::printStatusMessage("* token $stackPtr:$type added to conditions array *", ($level + 1));
                    }
                    ...
                    foreach (array_reverse($openers) as $opener) {
                        if ($this->tokens[$opener]['scope_closer'] === $i) {
                            ...
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                ...
                                Common::printStatusMessage("=> Found scope closer for $oldOpener:$type", ($level + 1));
                            }

                            $oldCondition = array_pop($conditions);
                            if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                Common::printStatusMessage('* token '.Tokens::tokenName($oldCondition).' removed from conditions array *', ($level + 1));
                            }
                            ...
                            if ($condition !== $oldCondition) {
                                if (isset($this->scopeOpeners[$oldCondition]['with'][$condition]) === false) {
                                    ...
                                    if (PHP_CODESNIFFER_VERBOSITY > 1) {
                                        ...
                                        Common::printStatusMessage("* scope closer was bad, cleaning up $badToken:$type *", ($level + 1));
                                    }
        ...
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
            Common::printStatusMessage('*** END LEVEL MAP ***', 1);
        }
